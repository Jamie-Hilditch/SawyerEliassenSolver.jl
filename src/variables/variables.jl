...
ZVariable{T} = Union{XZVariable{T},FZVariable{T}} where T
SVariable{T} = Union{XSVariable{T},FSVariable{T}} where T
CVariable{T} = Union{XCVariable{T},FCVariable{T}} where T
